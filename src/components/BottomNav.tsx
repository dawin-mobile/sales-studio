...
import { LayoutDashboard, BarChart2, PieChart, Calendar, Users, GraduationCap, Clock, Activity } from 'lucide-react';
...
const SECRET_NAV_ITEMS: { id: TabName; icon: React.ReactNode; label: string }[] = [
  ...
  { id: 'access-log', icon: <Activity      size={20} strokeWidth={1.75} />, label: 'アクセス' },
];
